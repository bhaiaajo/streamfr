...
function idToSource(id,tmdbid, type){
    if(type === "movie"){
        return {
            ...
            "rgshows.me": `https://rgshows.me/player/movies/api5/index.html?id=${tmdbid}`,
            ...
            "primewire.tf": `https://www.primewire.tf/embed/movie?tmdb=${tmdbid}`,
            ...
            "filmku.stream": `https://filmku.stream/embed/movie?tmdb=${tmdbid}`,
            "vidsrc.vip": `https://vidsrc.vip/embed/movie/${tmdbid}`,
            "gomo.to": `https://gomo.to/movie/${id}`,
            "nontongo.win":`https://nontongo.win/embed/movie/${tmdbid}`,
            "streamflix.one": `https://watch.streamflix.one/movie/${tmdbid}/watch?server=1`,
